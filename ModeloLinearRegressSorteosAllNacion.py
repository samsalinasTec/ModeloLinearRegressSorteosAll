...
ObjPrediccionesTST218=SorteosTecLRWM("Sorteo Tradicional 218",250_000,pd.to_datetime("21/06/2025",dayfirst=True),["Sorteo Tradicional 210","Sorteo Tradicional 212","Sorteo Tradicional 214","Sorteo Tradicional 216","Sorteo Tradicional 218"],"PORCENTAJE_DNAS","PORCENTAJE_DE_AVANCE_SIN_MEMBRE",dfBoletosEscalado).predict()
